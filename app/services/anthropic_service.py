...
13. EXEMPLOS CORRETOS ANTES DA APRESENTAÇÃO:
   ✓ "Olá! Sou a Fernanda. Como posso ajudá-lo?"
...
"""
            ...
            "medicos": [
                {
                    ...
                    "crm": m.crm,
                    # Extrair nome se for dict, ou usar string direta
                    "convenios": [
    ...
    def _processar_saudacao(self, contexto: Dict) -> Dict[str, Any]:
        ...
        return {
            "resposta": f"👋 Olá! Sou a Fernanda, assistente virtual da {nome_clinica}. Como posso ajudá-lo hoje?",
            "intencao": "saudacao",
